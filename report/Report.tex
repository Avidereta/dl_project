...
parameters are neccessary for depth map building.
    ...
    \begin{figure}[htbp]
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{images/disparity_scheme.png}
    \end{center}
\caption{}
\end{figure}
...
perspective, local refinements are made by fine-scale network.
    ...
    \begin{figure}[htbp]
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{images/network_structure.png}
    \end{center}
\caption{}
\end{figure}
...
<matplotlib.figure.Figure at 0x18b410d0>
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Report_files/Report_110_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
